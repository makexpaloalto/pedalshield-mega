...
// pedalshield_mega_signal_generator.ino plays a waveform stores in memory (waveform[])
...
void loop() 
{
 ...
 do {
   ...
   u8g.drawStr( 0, 16, "    SIGNAL  ");    
   u8g.drawStr( 0, 36, " GENERATOR ");  
...
if (!digitalRead(PUSHBUTTON_2)) {
 ...
 OCR4AL =waveform[sample];
 OCR4BL = waveform[sample];
}
